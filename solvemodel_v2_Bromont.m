...
function [MyLake_results, sediment_results] = ...
    solvemodel_v2_Mil(M_start,M_stop,Initfile,Initsheet,Inputfile,Inputsheet,Parafile,Parasheet,enable_sediment,varargin)

addpath(genpath('.\MyLake-v2.0'))
addpath(genpath('.\Sediment-v2.0'))
...
sediment_module = enable_sediment;            % sediment diagenetic module  %% NEW_DOCOMO %MC change to disable sediment
...
if (nargin>9) %if optional command line parameter input is used % MC change to add the switch variable as input
